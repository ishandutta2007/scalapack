      SUBROUTINE PCGEEQU( M, N, A, IA, JA, DESCA, R, C, ROWCND, COLCND,
     $                    AMAX, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PCGEEQU computes row and column scalings intended to equilibrate an
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCGEEQU', -INFO )
         RETURN
      END IF
*
